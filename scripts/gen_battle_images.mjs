...
const UAT_JOBS = {
  ...
  // G7 帰結(4 枚)
  uat_g7_win_kuzureru: {
    // 注: 初稿の「焦げて乱れ」「苦しげ」を含む文言は Unprocessable Entity(ポリシー拒否)に
    // なったため、負傷描写を避けた表現へ調整済み(2026-07-18)。
    refs: [R.goshiFace, R.goshiBody],
    prompt:
      "参考画像のキャラクター(後白河法皇)が力を使い果たし、雪原に片膝をついて" +
      "うなだれる敗北のカット。" +
      "体に張り付いていた深紅の氷の結晶が砕けて、赤い光の粒となってきらきらと舞い散り、" +
      "空へ昇っていく。傍らの雪面に大数珠が落ちている。" +
      "静かに決着がついた余韻のあるシーン。" +
      UAT_BATTLE_BG +
      GOSHIRAKAWA_DESIGN +
      KEEP_DESIGN +
