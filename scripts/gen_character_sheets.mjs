...
const CHARACTERS = {
  ...
  // 黒幕 = 後白河法皇。デザインは案 A「若き覇王」で確定(2026-07-17)。
  // 参考画像はどちらも生成物(全身 = gen_goshirakawa_design.mjs / 顔 = gen_goshirakawa_face.mjs)
  後白河: {
    face: `${REF_ROOT}/黒幕/後白河_顔アップ.png`,
    body: `${REF_ROOT}/黒幕/後白河_案A_全身.png`,
    desc: "剃髪で額に赤い氷の結晶の紋様を持つ、白い法衣 + 柿渋色の袈裟の若き法皇(後白河)",
  },
};
